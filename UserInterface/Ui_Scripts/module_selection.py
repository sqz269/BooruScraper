...
class Ui_ModuleSelectionWindow(object):
    ...
    def retranslateUi(self, ModuleSelectionWindow):
        ...
        self.module_selection_tab.setTabText(self.module_selection_tab.indexOf(self.tab_pixiv),
                                             _translate("ModuleSelectionWindow", "Pixiv"))
        self.label.setText(_translate("ModuleSelectionWindow", "Coming Soon (Probably)"))
        self.module_selection_tab.setTabText(self.module_selection_tab.indexOf(self.tab_pixiv_fast),
                                             _translate("ModuleSelectionWindow", "Pixiv Fast"))
        self.label_2.setText(_translate("ModuleSelectionWindow", "Coming Soon (Probably)"))
        self.module_selection_tab.setTabText(self.module_selection_tab.indexOf(self.tab_danbooru),
                                             _translate("ModuleSelectionWindow", "Danbooru"))
        self.label_3.setText(_translate("ModuleSelectionWindow", "Coming Soon (Probably)"))
        self.module_selection_tab.setTabText(self.module_selection_tab.indexOf(self.tab_gelbooru),
                                             _translate("ModuleSelectionWindow", "Gelbooru"))
